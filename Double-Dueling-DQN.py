...
path = "/mnt/chromeos/removable/SDCard/data/dqn/medium" #The path to save our model to.
...
#saver = tf.train.import_meta_graph(path+'/model-'+str(i)+'.meta')
#saver.restore(sess,path+'/model-'+str(i)+'.ckpt')
